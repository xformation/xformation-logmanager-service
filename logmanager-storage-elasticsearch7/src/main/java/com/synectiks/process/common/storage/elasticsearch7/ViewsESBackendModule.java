...
import com.synectiks.process.common.storage.elasticsearch7.views.searchtypes.ESEventList;
...
import com.synectiks.process.common.storage.elasticsearch7.views.searchtypes.pivot.buckets.ESDateRangeHandler;
import com.synectiks.process.common.storage.elasticsearch7.views.searchtypes.pivot.buckets.ESTimeHandler;
import com.synectiks.process.common.storage.elasticsearch7.views.searchtypes.pivot.buckets.ESValuesHandler;
import com.synectiks.process.common.storage.elasticsearch7.views.searchtypes.pivot.series.ESAverageHandler;
import com.synectiks.process.common.storage.elasticsearch7.views.searchtypes.pivot.series.ESCardinalityHandler;
import com.synectiks.process.common.storage.elasticsearch7.views.searchtypes.pivot.series.ESCountHandler;
import com.synectiks.process.common.storage.elasticsearch7.views.searchtypes.pivot.series.ESMaxHandler;
import com.synectiks.process.common.storage.elasticsearch7.views.searchtypes.pivot.series.ESMinHandler;
import com.synectiks.process.common.storage.elasticsearch7.views.searchtypes.pivot.series.ESPercentilesHandler;
import com.synectiks.process.common.storage.elasticsearch7.views.searchtypes.pivot.series.ESStdDevHandler;
import com.synectiks.process.common.storage.elasticsearch7.views.searchtypes.pivot.series.ESSumHandler;
import com.synectiks.process.common.storage.elasticsearch7.views.searchtypes.pivot.series.ESSumOfSquaresHandler;
import com.synectiks.process.common.storage.elasticsearch7.views.searchtypes.pivot.series.ESVarianceHandler;
...
public class ViewsESBackendModule extends ViewsModule {
    ...
    protected void configure() {
        ...
        bindRequestStrategy().to(com.synectiks.process.common.storage.elasticsearch7.views.export.SearchAfter.class);
    }
