...
public class ${pluginClassName}MetaData implements PluginMetaData {
    private static final String PLUGIN_PROPERTIES = "${groupId}.${artifactId}/logmanager-plugin.properties";
    ...
    public Version getRequiredVersion() {
        return Version.fromPluginProperties(getClass(), PLUGIN_PROPERTIES, "logmanager.version", Version.from(0, 0, 0, "unknown"));
    }
