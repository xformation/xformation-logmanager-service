  ...
  getInitialState() {
    return {
      indexSet: {
        ...
        shards: 4,
        replicas: 0,
        retention_strategy_class: 'com.synectiks.process.server.indexer.retention.strategies.DeletionRetentionStrategy',
        retention_strategy: {
          max_number_of_indices: 20,
          type: 'com.synectiks.process.server.indexer.retention.strategies.DeletionRetentionStrategyConfig',
        },
        rotation_strategy_class: 'com.synectiks.process.server.indexer.rotation.strategies.MessageCountRotationStrategy',
        rotation_strategy: {
          max_docs_per_index: 20000000,
          type: 'com.synectiks.process.server.indexer.rotation.strategies.MessageCountRotationStrategyConfig',
        },
