...
public abstract class IndexFieldTypePollerIT extends ElasticsearchBaseTest {
    ...
    public void poll() {
        ...
        assertThat(dto.fields()).containsOnly(
                ...
                FieldTypeDTO.create("xflog_receive_timestamp", "date"),
                FieldTypeDTO.create("xflog_processing_timestamp", "date"),
                FieldTypeDTO.create("xflog_accounted_message_size", "long"),
