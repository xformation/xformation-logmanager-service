...
public class Beats2CodecTest {
    ...
    public void decodeMessagesHandlesFilebeatMessagesWithoutPrefix() throws Exception {
        ...
        assertThat(message.getField(Message.FIELD_XFLOG_SOURCE_COLLECTOR)).isEqualTo("1234-5678-1234-5678");
        assertThat(message.getField("filebeat_" + Message.FIELD_XFLOG_SOURCE_COLLECTOR)).isNull();
